      ...
      <tbody>
        <tr v-for="(arn, index) in schemaArns">
          ...
          <td class="mdl-data-table__cell--non-numeric">
            <router-link :to="{ name: 'SchemaUpdate', params: { SchemaArn: arn }}" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored">Update</router-link>
            <router-link :to="{ name: 'SchemaPublish', params: { SchemaArn: arn }}" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent">Publish</router-link>
