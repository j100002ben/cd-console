<template>
  <div class="mdl-cell mdl-cell--6-col mdl-cell--3-offset schema-update">
    <h2>Development Schema Update <div v-if="loading" class="mdl-spinner mdl-js-spinner is-active"></div></h2>
