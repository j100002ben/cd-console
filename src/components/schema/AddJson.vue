<template>
  <div class="mdl-cell mdl-cell--6-col mdl-cell--3-offset schema-add">
    <h2>Development Schema Add From Json</h2>
    <form @submit.prevent="addSchema">
      ...
      <p class="mdl-typography--text-center submit-form">
        <button type="submit" class="mdl-button mdl-js-button mdl-button--primary">Add Schema</button> or 
        <router-link :to="{ name: 'SchemaAdd'}" class="other-submit-method">Create Only Schema Name</router-link>
      </p>
    </form>
  </div>
</template>
